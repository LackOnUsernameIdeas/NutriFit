  ...
  const generatePlanWithGemini = async () => {
    try {
      ...
      const prompt = `Вие сте опитен диетолог, който наблюдава пациентите си дали консумират само ядлива храна от ${
        ...
        Стойността на "grams" е количеството, което потребителя трябва да изяде и НИКОГА не трябва да е под 150.
        Препоръчвай всеки път различни ястия от миналият ти отговор.`;
