      ...
      const response = await fetch(
        "https://api.openai.com/v1/chat/completions",
        {
          ...
          headers: {
            ...
            Authorization:
              "Bearer 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"
          },
          body: JSON.stringify({
